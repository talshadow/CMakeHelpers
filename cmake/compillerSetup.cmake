...
macro (CompillerSetupParams)
	...
	if( CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_GNUCXX )
		SET(EXTEND_WARNINGS_GCC_C "-Wall -Wextra")
		SET(EXTEND_WARNINGS_GCC_CXX "-Wdelete-non-virtual-dtor ${EXTEND_WARNINGS_GCC_C}")
                set(REMOVING_REGEX "(-Wl,)?-flto" "-O([0,1,2,3,s,g]|fast)?" "-Wl,--as-needed" "-Wl,--strip-all" "-fomit-frame-pointer")
		unset(APPEND_SYMBOL)
		...
		foreach(_lang C CXX)
			foreach(configs RELEASE RELWITHDEBINFO MINSIZEREL DEBUG)
                                string(REGEX REPLACE "-O([0,1,2,3,s,g]|fast)?[ ]?" "" CMAKE_${_lang}_FLAGS_${configs} "${CMAKE_${_lang}_FLAGS_${configs}}" )
			...
			if(CMAKE_BUILD_TYPE)
				...
				set(CMAKE_${_lang}_FLAGS_RELEASE "${CMAKE_${_lang}_FLAGS} ${CMAKE_${_lang}_FLAGS_RELEASE}")
                        ...
                        SET(CMAKE_${_lang}_FLAGS_DEBUG "${CMAKE_${_lang}_FLAGS_DEBUG} -Og ${EXTEND_WARNINGS_GCC_CXX}")
